...
{
    public class Student:Person //Student inherits from Peson
    {
        //Student specific property
        [Display(Name = "Enrollment Date")] //always starts [] in annotation
        ...
        /*
         * The enrollments property in a navigation property (EF Core)- Navigation properties
         ...
         * Note: Lazy loading is not yet available in EF Core (that has in EF 5, 6...)
         * 
