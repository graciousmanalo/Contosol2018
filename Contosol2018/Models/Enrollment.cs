...
namespace ContosoUniversity2018.Models
{
    ...
    {
        /*
         * The EnrollmentID property will be the Primary Key: this entity used the ClassNameID
         * pattern instead of the ID by itself that you have in the Student Entity
         */
        ...
        public Grade? Grade { get; set; } //The question mark(?) is nullable - because we don't start with a grade
